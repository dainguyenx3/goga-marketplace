...
const GogaNftHistory = ({ history, page, max,handleChangePage, currencyBalance }: TransactionHistoryProps) => {
    ...
    return (
        <div className="tab-panel">
            <div className="panel" id="box-history"></div>    
                ...
                <div className="panel active" id="goga-nfts-history">
                        ...
                        <tbody>
                            {
                                history.map((item: any) => {
                                    return (
                                        <tr key={item.id}>
                                            <td>
                                                <p><img style={{maxWidth: '47px', maxHeight: '47px'}} src={item.imageUrl?.replace(REGEX_IMAGE, ".png")} alt="" /> {'#' + item.tokenId}</p>
                                            </td>
                                            <td>
            ...
            <div className="panel" id="transaction-history"></div>    
        </div>
    )
}

export default GogaNftHistory;